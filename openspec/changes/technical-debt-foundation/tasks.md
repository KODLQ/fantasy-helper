...
- [x] 1.3 Surface drawer, compare, auth, manager, and analysis errors with common loading/empty/stale/partial states.
...
- [x] 2.5 Run formatting, static checks, unit tests, integration tests, builds, contract tests, and headed Playwright tests.
