...
- [ ] 3.2 Implement idempotent entry summary/history and transfer synchronization.
- [ ] 3.3 Implement gameweek picks synchronization with durable gameweek checkpoints.
...
- [ ] 4.1 Add league configuration, league metadata, standings snapshot, and standings-member tables.
- [ ] 4.2 Add paginated classic-league standings adapter with phase and page parameters.
- [ ] 4.3 Implement durable page work items, pagination checkpoints, idempotent upserts, and partial-page retention.
...
- [ ] 5.3 Add manager and league sync status/error reporting separate from public sync status.
