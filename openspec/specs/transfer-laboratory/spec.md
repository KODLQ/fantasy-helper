# transfer-laboratory Specification

## Purpose

Define safe, deadline-aware transfer simulations that validate FPL constraints, explain their costs and effects, and never mutate an active manager team.
