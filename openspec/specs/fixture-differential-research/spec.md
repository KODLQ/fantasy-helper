# fixture-differential-research Specification

## Purpose

Define reproducible fixture-swing and differential-player research using bounded horizons, versioned formulas, explicit provenance, and honest missing-data states.
